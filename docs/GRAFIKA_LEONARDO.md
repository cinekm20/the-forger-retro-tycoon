...
| 9 | 4 | Fazy wzrostu roślin (4 uprawy × 3 fazy) | 12 | 1:1, transparent (PNG) | §3 | ✅ zrobione i podpięte — wszystkie 12 (`crops/<uprawa>_<faza>.png`, np. `coffee_seedling.png`/`coffee_growing.png`/`coffee_harvest.png`), rysowane w `PlantationTileIcon.gd` zamiast kolorowego kółka; faza wybierana automatycznie wg czasu od ostatnich zbiorów (`Plantation.gd _rebuild_grid`, czysto kosmetyczne) |
