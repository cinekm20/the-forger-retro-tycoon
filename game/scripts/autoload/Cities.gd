...
const MAP_POSITION := {
	"berlin": Vector2(0.525, 0.335),
	"paris": Vector2(0.495, 0.36),
	"amsterdam": Vector2(0.50, 0.335),
	"lisbon": Vector2(0.47, 0.41),
	"london": Vector2(0.485, 0.335),
	"ankara": Vector2(0.57, 0.41),
	"bombay": Vector2(0.68, 0.53),
	"colombo": Vector2(0.703, 0.58),
	"mombasa": Vector2(0.585, 0.625),
	"duala": Vector2(0.515, 0.59),
	"abidjan": Vector2(0.48, 0.59),
	"rio": Vector2(0.375, 0.725),
	"bogota": Vector2(0.30, 0.59),
	"guatemala": Vector2(0.255, 0.54),
	"mexico": Vector2(0.235, 0.525),
	"new_york": Vector2(0.315, 0.365),
	"richmond": Vector2(0.295, 0.385),
	"st_louis": Vector2(0.245, 0.395),
}
